var App = function () {
    ...
    var handleEditableTables = function () {
        ...
        function editRow(oTable, nRow) {
            ...
            jqTds[4].innerHTML = '<a class="edit" href=""><i class="icon-undo"></i></a>';
            jqTds[5].innerHTML = '<a class="cancel" href=""><i class="icon-remove"></i></a>';
        }
        ...
        function saveRow(oTable, nRow) {
            ...
            oTable.fnUpdate('<a class="edit" href=""><i class="icon-edit"></i></a>', nRow, 4, false);
            oTable.fnUpdate('<a class="delete" href=""><i class="icon-remove"></i></a>', nRow, 5, false);
            oTable.fnDraw();
        }
        ...
        function cancelEditRow(oTable, nRow) {
            ...
            oTable.fnUpdate(jqInputs[2].value, nRow, 2, false);
            oTable.fnUpdate(jqInputs[3].value, nRow, 3, false);
            oTable.fnUpdate('<a class="edit" href=""><i class="icon-undo"></i></a>', nRow, 4, false);
            oTable.fnDraw();
        }
        ...
        $('#sample_editable_1_new').click(function (e) {
            ...
            var aiNew = oTable.fnAddData(['', '', '', '',
                '<a class="edit" href="">Edit</a>', '<a class="cancel" data-mode="new" href=""><i class="icon-remove"></i></a>']);
    ...
    var handleDateTimePickers = function () {
        ...
        $('#form-date-range').daterangepicker({
            ranges: {
                'Hoje': ['today', 'today'],
                'Ontem': ['yesterday', 'yesterday'],
                'Nos últimos 7 dias': [Date.today().add({
                    days: -6
                }), 'today'],
                'Nos últimos 30 dias': [Date.today().add({
                    days: -29
                }), 'today'],
            ...
            locale: {
                ...
                fromLabel: 'De',
                toLabel: 'Para',
                customRangeLabel: 'Selecione o período',
